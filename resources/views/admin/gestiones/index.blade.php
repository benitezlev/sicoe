    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="gestiones" class="table table-bordered table-hover table-striped table-sm">
                        <thead>
                        <tr>
...
@section('js')
    <script>
        $(function () {
            ...
            }).buttons().container().appendTo('#gestiones_wrapper .row:eq(0)');
        });
    </script>
@stop
