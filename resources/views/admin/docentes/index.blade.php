                ...
                <div class="card-body">
                    <table id="administrativos" class="table table-bordered table-hover table-striped table-sm">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Clave de Servidor</th>
                        ...
                        @foreach($docentes as $docente)
                            <tr>
                                ...
                                <td style="text-align: center">{{$docente->cve_servidor}}</td>
                                <td style="text-align: center">{{$docente->adscrip}}</td>
                                <td style="text-align: center">{{$docente->usuario->roles->pluck('name')->implode(', ')}}</td>
                                <td style="text-align: center">{{$docente->profesion}}</td>
